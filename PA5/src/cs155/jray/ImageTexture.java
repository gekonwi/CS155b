...
public class ImageTexture extends Texture{
    ...
    /**
       This returns a Color corresponding to the pixel
       whose location in the image is (x,y) after the image
       is normalized to have size 1.0 x 1.0
     **/
    public Color3D getColor(TextureCoordinate tc) {
        if ((buf == null) || (w<1) || (h<1))  return Color3D.WHITE;
