...
Once a collection of objects are grouped they can be transformed by
a single transform operator!
 **/
public class Group3D extends Object3D {
    ...
    //  x.rayIntersect(ray) -- returns a double, POSITIVE_INFINITY for no intersection, t>0 for intersection at value t
