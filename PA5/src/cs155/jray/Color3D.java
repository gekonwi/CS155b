 ...
 * coerce to integers in the range [0,255]. This class also has methods
 * to add, multiply, and scale colors.
 **/
...
public class Color3D {
	...
	public static Color3D weightedAverage(Color3D a, Color3D b, double wa, double wb){
