...
public class PA04Demo {
	...
	private static Scene3D initScene(){
		...
		Cylinder3D cyl1 = new Cylinder3D(new Point3D(1,0,-15),new Point3D(-1,1,-3),3.0,15.0,mat2);
		Cylinder3D cyl2 = new Cylinder3D(new Point3D(3,0,-15),new Point3D(1,1,-1),3.0,15.0,mat3);
		Sphere3D sp2 = new Sphere3D(new Point3D(-25,-5,-45),20.0,mat4);
		Plane3D pl1 = new Plane3D(new Point3D(0,-1,0),new Point3D(0,1,0),mat1);
		
		// create the lights
		Light3D light1 = new Light3D(new Point3D(-25,15,-5),0.3);// this light comes from above on the left
		...
		Light3D light4 = new Light3D(new Point3D(-2,3,-24),1.0); // this light is inside cylinder 1, toward the far end
		
		cyl2.insideMat = mat4; // here we change the material on the inside of cylinder 2
		...
		camTransf = camTransf.translate(0,0,-20).rotateY(-70).rotateX(60).translate(0,0,50);
