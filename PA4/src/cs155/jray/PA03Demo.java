 ...
 *
 */
public class PA03Demo {
	private static Scene3D scene = new Scene3D();	
    private static RayCanvas3D mc = new RayCanvas3D(scene,800,800);
	...
	private static Scene3D initScene2(){
		...
		Material mat1 = new Material(new Color3D(0d,0d,0d), new Color3D(1d,0d,0d), new Color3D(1d,1d,1d), new Color3D(0d,1d,0d),200);
		Material mat2 = new Material(new Color3D(0d,0d,0d), new Color3D(0d,0d,0d), new Color3D(1d,1d,0d), new Color3D(1d,1d,1d),200);
		Material mat3 = new Material(new Color3D(0d,0d,0d), new Color3D(0d,0d,0d), new Color3D(1d,0d,0d), new Color3D(1d,1d,1d),200);
		Material mat4 = new Material(new Color3D(0d,0d,0d), new Color3D(0d,0d,0d), new Color3D(0d,1d,0d), new Color3D(1d,1d,1d),200);
		Material mat5 = new Material(new Color3D(0d,0d,0d), new Color3D(0d,0d,0d), new Color3D(1d,1d,1d), new Color3D(1d,0d,0d),200);
		Sphere3D sp1 = new Sphere3D(new Point3D(0,0,-5),2.0,mat1);
		...
		scene.add(light2);
		scene.add(cam);
		cam.apply(new Transform3D().rotateY(45d).rotateX(45d).translate(0d,5d,10d));
		return scene;
