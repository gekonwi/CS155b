...
import cs155.jray.view.CamControl;
import cs155.jray.view.CamRotationControl;
import cs155.jray.view.CamTranslationControl;
...
public class PA04Demo {
	...
	private static void createAndShowGUI() {
		...
		new CamTranslationControl(mc).setVisible(true);
		new CamRotationControl(mc).setVisible(true);
	}
	...
	private static Scene3D initScene() {
		...
		// camTransf =
		// camTransf.translate(0,0,-20).rotateY(-70).rotateX(60).translate(0,0,50);
